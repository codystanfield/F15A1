...
CREATE UNIQUE INDEX F15A1_Auth__IDX ON F15A1_Auth
  (
    F15A1_emp_emp_id ASC
  )
  ;
...
CREATE TABLE F15A1_emp
  (
    ...
    emp_system_admin_flag CHAR (1) ,
    emp_chairperson_flag  CHAR (1) ,
    emp_admin_flag        CHAR (1) ,
    emp_labdir_flag       CHAR (1) ,
    emp_execdir_flag      CHAR (1) ,
    emp_chair_flag        CHAR (1)
  ) ;
CREATE UNIQUE INDEX F15A1_emp__IDX ON F15A1_emp
  (
    F15A1_Auth_auth_id ASC
  )
  ;
...
CREATE TABLE F15A1_role_type_code
  (
    role_code_id     INTEGER NOT NULL ,
    role_type        VARCHAR2 (30) ,
    role_description VARCHAR2 (500)
  ) ;
ALTER TABLE F15A1_role_type_code ADD CONSTRAINT F15A1_rtc_PK PRIMARY KEY ( role_code_id ) ;
...
ALTER TABLE rfe_task_relationship ADD CONSTRAINT rfe_task_relationship_PK PRIMARY KEY ( F15A1_rfe_rfe_id, F15A1_Task_task_id ) ;


ALTER TABLE F15A1_Auth ADD CONSTRAINT F15A1_Auth_F15A1_emp_FK FOREIGN KEY ( F15A1_emp_emp_id ) REFERENCES F15A1_emp ( emp_id ) ;
...
ALTER TABLE F15A1_contact ADD CONSTRAINT F15A1_contact_F15A1_rtc_FK FOREIGN KEY ( F15A1_rtc_rc_id ) REFERENCES F15A1_role_type_code ( role_code_id ) ;
...
ALTER TABLE rfe_task_relationship ADD CONSTRAINT FK_ASS_15 FOREIGN KEY ( F15A1_rfe_rfe_id ) REFERENCES F15A1_rfe ( rfe_id ) ;

ALTER TABLE rfe_task_relationship ADD CONSTRAINT FK_ASS_16 FOREIGN KEY ( F15A1_Task_task_id ) REFERENCES F15A1_Task ( task_id ) ;
